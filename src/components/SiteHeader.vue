  ...
  <header class="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
    ...
    >
      <div class="hidden xl:block xl:relative xl:max-w-xs xl:w-full">
        ...
        <input
          class="block w-full border border-transparent bg-gray-200 focus:outline-none focus:bg-white focus:text-gray-300 focus:border-gray-300 text-white rounded-lg pl-10 pr-4 py-2"
